...
class MarketPlaceSeederTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data['dedicated_theme_heading'] = 'BruNwa Car Services ThemeEmpowers Your Business';
        $data['dedicated_theme_description'] = '<p>Running a car service business should not feel like navigating a stormy sea. BruNwa Car Services Theme is your trusty captain, offering a user-friendly online platform that streamlines your workflow, builds trust with clients, and frees you up to focus on smooth sailing – delivering exceptional service</p>';
