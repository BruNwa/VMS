    ...
    public static function CompanySetting($id = null,$businee_id = null)
    {
        ...
        if(!empty($id))
        {
            ...
            $company_setting = [
                ...
                "title_text" => !empty($admin_settings['title_text']) ? $admin_settings['title_text'] : "BruNwa",
                "footer_text" => !empty($admin_settings['footer_text']) ? $admin_settings['footer_text'] :"Copyright © BruNwa",
