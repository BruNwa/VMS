            ...
            <div class="row">
                <div class="lg:col-6 md:col-6 col-12 md:pr-0">
                    ...
                    <div class="flex flex-shrink gap-4 md:gap-6 mb-8 mt-6 md:mt-12">
                        <a href="{{ route('check-in.step-one') }}"><button type="submit" class="group lg:py-3 py-2 lg:pl-8 pl-6 pr-2 whitespace-nowrap bg-primary text-white rounded-[30px] lg:text-[22px] text-base font-bold flex  items-center gap-4">{{__('all.check_in')}}<div class="w-9 h-9 rounded-full bg-[rgba(255,255,255,0.3)] flex justify-center items-center -rotate-45"><i class="fa-solid fa-arrow-right"></i></div> </button></a>
                        <a href="{{ route('check-in.scan-qr') }}"><button type="submit" class="lg:py-3 py-2 lg:pl-8 pl-6 pr-2 whitespace-nowrap text-primary border-primary border rounded-[30px] lg:text-[22px] text-base font-bold flex justify-end items-center gap-4 leading-tight">{{__('all.scan_qr')}}<div class="w-9 h-9 rounded-full bg-[#DEDFFF] flex justify-center items-center"><img src="{{ asset('frontend/images/hero/Qr Code.png') }}" alt="qr"></div></button></a>
                    </div>
                </div>
