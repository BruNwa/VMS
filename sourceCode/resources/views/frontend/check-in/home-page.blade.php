            ...
            <div class="row">
                <div class="lg:col-6 md:col-6 col-12 md:pr-0  md:mt-5 mb-12">
                    ...
                    <div class="flex gap-4 md:gap-6 mt-6 md:mt-12">
                        <a href="{{ route('check-in.step-one') }}"><button type="submit" class="lg:py-3 py-2 lg:pl-8 pl-6 pr-2 whitespace-nowrap bg-primary text-white rounded-[30px] lg:text-[22px] text-base font-bold flex  items-center gap-4">{{__('all.check_in')}}
                        ...
                        <a href="{{ route('check-in.scan-qr') }}"> <button type="submit" class="lg:py-3 py-2 lg:pl-8 pl-6 pr-2 whitespace-nowrap backdrop-blur text-primary border-primary border rounded-[30px] lg:text-[22px] text-base font-bold flex justify-end items-center gap-4 leading-tight">{{__('all.scan_qr')}}
