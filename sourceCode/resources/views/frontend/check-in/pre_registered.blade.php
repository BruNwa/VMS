        ...
        <div class="pb-12 pt-12 md:pt-14 lg:pt-20">
            <div class="row">
                <div class="lg:col-6 md:col-6 col-12 md:pr-0 mt-0 md:mt-16 mb-20">
                    <h1 class="text-2xl sm:text-[32px] font-extrabold text-primary mb-6 leading-none">{{__('all.pre_registered_visitor_details')}}</h1>
                    <form action="{{ route('check-in.find.pre.visitor') }}" method="POST">
                        ...
                        <a href=" ./index.html"><button type="reset" class="bg-danger text-white px-6 py-3 rounded-3xl shadow-btnDanger text-lg font-bold leading-snug">{{__('all.cancel')}}</button></a>
