    ...
    <div class="row">
        <div class="col-12">
            <div class="custome-breadcrumb">
                {{ Breadcrumbs::render('pre-registers-report') }}
            </div>
            <div class="col-12">
                <div class="db-card">
                    <div class="db-card-header border-none">
                        <h3 class="db-card-title">{{ __('all.pre_register_report') }}</h3>
                        <div class="db-card-filter">
                            ...
                            <div class="dropdown-group">
                                ...
                                <div class="dropdown-list db-card-filter-dropdown-list">
                                    <a href="javascript:void(0);" onclick="printDiv('printTableArea')"
                                        class="db-card-filter-dropdown-menu">
                    ...
                    <div id="printTableArea">
                        <div class="db-table-responsive">
                            <table class="db-table stripe" id="maintable" data-url="{{ route('admin.report.pre-registers.list') }}" data-status="{{ \App\Enums\Status::ACTIVE }}">
