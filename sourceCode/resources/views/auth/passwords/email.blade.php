                ...
                <div class="col-12 md:col-6 !py-0">
                    <div class="py-6 px-4 md:px-6 md:pr-0">
                        <form method="POST" action="{{ route('password.email') }}">
                            @csrf
                            <h1 class="text-2xl sm:text-[32px] font-extrabold text-primary mb-8 md:mb-12 leading-none">{{ __('all.reset_password') }}</h1>
                            <div class="mb-6">
                            ...
                            <button type="submit" class="text-lg font-bold leading-snug text-white bg-primary rounded-[23.5px] px-6 py-3 w-full shadow-btnNext">{{ __('all.send_password_reset_link') }}</button>
                        </form>
                    </div>
                </div>
